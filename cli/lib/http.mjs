...
export function tlsHint(host, code) {
  return [
    ...
    "",
    "  Solución más simple (Node ≥ 22.15): usá el trust store del sistema, donde tu navegador",
    "  ya confía en la CA de tu empresa:",
    "    Windows (PowerShell):  $env:NODE_OPTIONS=\"--use-system-ca\"",
    "    macOS / Linux:         export NODE_OPTIONS=--use-system-ca",
    "",
    "  Alternativa (cualquier versión de Node): exportá la CA raíz de tu empresa a un .pem",
    "  y declarásela a Node:",
